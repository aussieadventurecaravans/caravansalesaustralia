					...
					if ( !is_advanced_mode_forced() || ic_is_woo_template_available() || is_ic_shortcode_integration() ) {
						...
						if ( is_ic_shortcode_integration() ) {
							...
							<div class="simple_mode_settings">
								...
								implecode_info( __( 'In simple mode you will have to use shortcodes to display category pages. The advanced mode will display them for you automatically.', 'ecommerce-product-catalog' ) . '</p>' .
