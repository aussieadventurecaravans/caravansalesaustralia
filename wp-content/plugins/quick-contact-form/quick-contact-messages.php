...
function qcf_show_messages($id) {
    ...
    <p>'.__('Upgrading let you create a mailing list, send emails from your dashboard. You can also view and access message attachments on this page. All for just $10.','qcf').'</p>
